...
const NavBar = (props) => {
    const initialNavigation = [
        { id: 1, name: 'Home', ref: props.refs.myRefs.home, current: true },
        { id: 2, name: 'About', ref: props.refs.myRefs.about, current: false },
        { id: 3, name: 'Experience', ref: props.refs.myRefs.experience, current: false },
        { id: 4, name: 'Skills', ref: props.refs.myRefs.skills, current: false },
        { id: 5, name: 'Projects', ref: props.refs.myRefs.projects, current: false },
        { id: 6, name: 'Contact Me', ref: props.refs.myRefs.contact, current: false },
    ]
